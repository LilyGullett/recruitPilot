...
timeData <- read_csv("../data/time/timeData.csv", show_col_types = FALSE)
...
#practiceGraph <- ggplot(data = timeData, aes(x = daysPostSettlement, y = scanTime))
...
practicePlot <- ggplot() + geom_boxplot(data=timeData, aes(x=timePoint, y=numberPhotos)) +
    xlab("Timepoint") + ylab("Number of Photos Taken") +
