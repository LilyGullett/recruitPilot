...
scanPlot <- ggplot(timeData, aes(x = timepoint, y = scanTime)) + geom_bar(position = 'dodge', stat = 'identity', aes(fill = timepoint))+
  facet_grid(.~rack, scales = 'free')+ xlab("Timepoint") + ylab("Time Taken (minutes)") +
...
trainedPlot <- ggplot(timeData, aes(x = timepoint, y = scanTime)) + geom_bar(position = 'dodge', stat = 'identity', aes(fill = timepoint))+
  facet_grid(.~rack, scales = 'free')+ xlab("Timepoint") + ylab("Time Taken (minutes)") +
